                     ...
                     <ul class="info_option_wrp stat_action pull-left">
                        <li>
                           <div class="item target_date">
                              ...
                              <div style="visibility:hidden;" id="actionposition"></div>
                           </div>
                        </li>
                        <li>
                           <div class="item">
         ...
         <div class="modal-dialog draggable">
            ...
            <div class="modal-content draggable" id="uvModal">
               ...
               <div class="modal-body statopt_modalhead">
                  ...
                  <h5 style="visibility: hidden;" id="CurType"></h5> 
               </div>
               <div class="modal-body">
                     ...
                     <div class="col-md-12 p-0" style="padding:0px">
                         <div class="row">
                                <div class="col-sm-6 form-group" id="tooltip" >
                                       ...
                                       <input autocomplete="off" type="text" list="currlist" class="form-control" required=""  readonly="" onkeyup='activateButton("project_submit");' id="base_currency" >

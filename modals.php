      ...
      <div class="modal-content draggable" id="add_smModal">
         ...
         <div class="modal-body">
            ...
            <div class="form-group">
               ...
               <textarea type="text" class="form-control" id="add_strategy_statmnt" onkeyup='charcountupdate(this.value);' required rows="5" maxlength="500" placeholder="This is a Mandatory field" color="red"></textarea>
      ...
      <div class="modal-content draggable" id="projModal">
         ...
         <div class=" projects_modalbody cus_scroll">
            <div class="modal-body">
               ...
               <div class="col-md-12 p-0" style="padding:0px">
                  <div class="row">
                     <div class="col-sm-6 form-group" id="tooltip">
                        <label>Base Currency</label>
                        <span class="tooltiptext">Other Currencies will be available soon</span>
                        <input autocomplete="off" type="text" list="currlist" class="form-control" required="" onkeyup='activateButton("project_submit");' id="base_currency" readonly> 
      ...
      <div class="modal-content draggable" id="smModal">
         ...
         <div class="modal-body">
            ...
            <div class="input_wrp">
               ...
               <textarea type="text" class="form-control" id="strategy_statmnt" onkeyup='activateButton("Strategy_submit");' required rows="3" placeholder="This is a Mandatory field" color="red"></textarea>
            </div>
   ...
   <div class="modal-dialog draggable">
      ...
      <div class="modal-content draggable" id="undrop_modal_ss">
         ...
         <div class="modal-body">
            ...
            <div class="input_wrp">
               <label>Reason</label>
               <textarea type="text" class="form-control" id="undrop_reason" onkeyup='activateButton("Strategy_submit");' required rows="3" placeholder="This is a Mandatory field" color="red"></textarea>
   ...
   <div class="modal-dialog draggable">
      ...
      <div class="modal-content draggable" id="reopen_modal_ss">
         ...
         <div class="modal-body">
            ...
            <div class="input_wrp">
               <label>Reason</label>
               <textarea type="text" class="form-control" id="reopen_reason" onkeyup='activateButton("Strategy_submit");' required rows="3" placeholder="This is a Mandatory field" color="red"></textarea>
      ...
      <div class="modal-content draggable" id="unselect_modal_ss">
         ...
         <div class="modal-body">
            ...
            <div class="input_wrp">
               ...
               <textarea type="text" class="form-control" id="unimplement_reason" onkeyup='activateButton("Strategy_submit");' rows="3" placeholder="This is a Mandatory field" color="red" required></textarea>
      ...
      <div class="modal-content draggable" id="drop_modal_ss">
         ...
         <div class="modal-body">
            ...
            <div class="input_wrp">
               ...
               <textarea type="text" class="form-control" id="drop_reason" onkeyup='activateButton("Strategy_submit");' required rows="3" placeholder="This is a Mandatory field" color="red"></textarea>
   ...
   <div class="modal-dialog draggable">
      ...
      <div class="modal-content draggable" id="reselect_modal_ss">
         ...
         <div class="modal-body">
            ...
            <div class="input_wrp">
               <label>Reason</label>
               <textarea type="text" class="form-control" id="reselect_reason" onkeyup='activateButton("Strategy_submit");' required rows="3" placeholder="This is a Mandatory field" color="red"></textarea>
